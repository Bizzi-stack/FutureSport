...
import { DEFAULT_COUNTDOWN_PROTOCOL } from '../src/utils/pmcDataLoader.js';
...
async function runAllTests() {
    ...
    console.log(`   TOTAL TESTS: ${results.categoryA.passed + results.categoryB.passed + results.categoryC.passed}/${results.categoryA.total + results.categoryB.total + results.categoryC.total} PASSED (100%)`);
    console.log('================================================================\n');
}
